...
| 工具 | 用途 | 提示词说明 |
|------|------|-----------|
| Claude Code | 代码编写、调试、notebook修改 | 本次对话前三节，主要提示词如下 |
| Gemini 3.1Pro | 数学证明 | 本次对话最后一节使用，主要提示词如下 |
| Nanobanana 2 | 封面制作 |  如下|
**主要提示词参考：**
...
5. **严谨数学证明**
   - "严谨的证明在高维情况下，狄利克雷分布会发生中心集聚现象。"
6. **封面制作**
   - "生成一张极简书籍封面，只有三个元素，一个横置，从左往右开口的二次曲线，顶点位于画面的中间左侧，但距离边距还有一段距离，开口向右延伸直到伸出画面，在二次曲线的开口里，有一个正圆，中心与顶点齐平，两者都用淡红色渲染，线段粗，背景米白"
